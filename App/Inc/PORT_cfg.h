...
#define UART1_TX_PIN    PTA19       //PTA19、PTE0、PTC4                       PTA19不要用 （与晶振冲突）
...
#define TPM_CLKIN1_PIN  PTB17   //PTA19、PTB17、PTC13、PTE17、PTE30              PTA19不要用 （与晶振冲突）
...
//      模块通道    端口          可选范围                                    建议
#define TPM1_CH0_PIN    PTB0  //舵机    //PTA12、PTB0、PTE20
#define TPM1_CH1_PIN    PTA13       //PTA13、PTB1、PTE21

//      模块通道    端口          可选范围                                    建议
#define TPM2_CH0_PIN    PTB18     //PTA1、PTB2、PTB18、PTE22
#define TPM2_CH1_PIN    PTB19       //PTA2、PTB3、PTB19、PTE23  电机端口
...
#define SPI0_SCK_PIN    PTC5       // PTE17、PTA15、PTC5、PTD1        D1改变为PTA15
...
#define SPI0_PCS0_PIN   PTC4        // PTE16、PTA14、PTC4、PTD0            D0改变为PTA14
